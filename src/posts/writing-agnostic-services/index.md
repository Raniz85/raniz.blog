...
but I want to address how you can develop software so you can easily move it between providers or swap out specific technologies,
...
which is not always what we want. For example, AWS SQS is a very powerful message queue that is also simple to use; it's a solid choice if you're running on AWS and need a message queue.
...
Replacing these requires us to change the core,
